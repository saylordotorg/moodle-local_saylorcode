...
$string['checkdeferredattribution'] = 'Every external source is attributed';
$string['checkdeferredmetadata'] = 'Required exercise metadata is complete';
$string['checkdeferredpreview'] = 'The preview has been reviewed';
$string['checkfailnofeedback'] = 'No test case offers feedback, so a student who fails is told nothing useful.';
$string['checkfailnosolution'] = 'The exercise has no reference solution, so its tests cannot be shown to be right.';
$string['checkfailnotests'] = 'The exercise defines no test cases, so nothing can be graded.';
$string['checkfailnoversion'] = 'The exercise has no published version to approve. Publish the draft first.';
$string['checkfailruntime'] = 'The runtime {$a} is not available on this site.';
$string['checkfailsolution'] = 'The reference solution did not satisfy the tests: {$a}.';
$string['checkfailstableid'] = 'The exercise reference is not a valid stable id.';
$string['checksdeferredintro'] = 'These checks still rest on your judgement, because the plugin cannot yet establish them:';
...
$string['exerciseversionmissing'] = 'Version {$a} of this exercise does not exist. It may not have been published, or the reference may be wrong.';
$string['exerciseversionn'] = 'Version {$a}';
$string['exerciseversionshead'] = 'Published';
$string['exerciseviewnote'] = 'This is a read-only view of the published exercise. To write and run code, open it inside a course activity that uses it.';
...
$string['statusinreview'] = 'In review';
$string['statusmoved'] = 'Status changed to {$a}.';
$string['statusnotready'] = 'This exercise is not ready to be approved: {$a->failures}';
$string['statusready'] = 'Ready';
$string['statusretired'] = 'Retired';
$string['statustransitioninvalid'] = 'An exercise cannot go from {$a->from} to {$a->to}.';
$string['statusto'] = 'Move to {$a}';
...
$string['validate_help'] = 'Runs the reference solution against every test case on the real runner. An expected value that is subtly wrong looks perfectly plausible on this page and then fails every student, so it is worth proving before you publish.';
...
$string['validatesummarycompileerror'] = 'The reference solution did not compile.';
$string['validatesummaryfailed'] = 'The reference solution did not pass {$a->failed} of {$a->total} tests.';
$string['validatesummarynocases'] = 'Add at least one test case to validate against.';
$string['validatesummarynosolution'] = 'Add a reference solution to validate it.';
$string['validatesummarypassed'] = 'The reference solution passed all {$a} tests.';
$string['validatesummaryrunnerdown'] = 'The execution runner was unavailable. Try again shortly.';
