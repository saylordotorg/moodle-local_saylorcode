...
$string['publishedbutfailed'] = 'Published as version {$a->version}, but the reference solution did not pass every test: {$a->failed}. Students will be graded against these tests, so fix the draft and publish again.';
$string['publishedbutunchecked'] = 'Published as version {$a->version}. The reference solution could not be checked against the tests ({$a->reason}), so its correctness has not been confirmed.';
